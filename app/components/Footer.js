      ...
      <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div>
          ...
          <div className="flex items-center mt-1 space-x-3">
            <a href="https://wa.me/541123456789" target="_blank" title="WhatsApp" rel="noopener noreferrer" className="text-white transition-colors duration-300 hover:text-[#CBA240]" aria-label="WhatsApp">
            ...
            <a href="https://www.instagram.com/" target="_blank" title="Instagram" rel="noopener noreferrer" className="text-white transition-colors duration-300 hover:text-[#CBA240]" aria-label="Instagram">
              <svg viewBox="0 0 30 30" fill="currentColor" className="h-6">
                <circle cx="15" cy="15" r="4"></circle>
                <path d="M19.999,3h-10C6.14,3,3,6.141,3,10.001v10C3,23.86,6.141,27,10.001,27h10C23.86,27,27,23.859,27,19.999v-10   C27,6.14,23.859,3,19.999,3z M15,21c-3.309,0-6-2.691-6-6s2.691-6,6-6s6,2.691,6,6S18.309,21,15,21z M22,9c-0.552,0-1-0.448-1-1   c0-0.552,0.448-1,1-1s1,0.448,1,1C23,8.552,22.552,9,22,9z"/>
              </svg>
            </a>
            <a href="https://www.facebook.com/" target="_blank" title="Facebook" rel="noopener noreferrer" className="text-white transition-colors duration-300 hover:text-[#CBA240]" aria-label="Facebook">
              <svg viewBox="0 0 24 24" fill="currentColor" className="h-5">
